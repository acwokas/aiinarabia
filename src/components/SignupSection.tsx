          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="glass-button h-12 px-8 rounded-lg font-semibold text-sm bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:opacity-90 transition-all disabled:opacity-50 whitespace-nowrap cursor-pointer"
              >
