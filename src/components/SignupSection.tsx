...
const SignupSection = () => {
  ...
  return (
    <section id="signup" className="relative py-24 px-4 overflow-hidden">
      {/* Background texture */}
      <div
        className="absolute inset-0 opacity-[0.08] blur-lg"
        style={{
      ...
      <div className="relative z-10 max-w-xl mx-auto text-center">
        ...
        <div className="p-[1px] rounded-[21px] bg-gradient-to-r from-primary/30 via-secondary/20 to-primary/30">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                <Input
                  ...
                  required
                  maxLength={255}
                  className="glass-input flex-1 h-12 text-base placeholder:text-muted-foreground/50 focus-visible:ring-0"
                />
                <button
                  type="submit"
                  disabled={loading}
                  className="glass-button h-14 px-8 rounded-lg font-semibold text-base bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:opacity-90 transition-all disabled:opacity-50 whitespace-nowrap cursor-pointer"
                >
